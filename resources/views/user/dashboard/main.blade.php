                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="box_main_3">
                            ...
                            <div class="image_2"><img src="{{ asset('template-user/images/img-3.png') }}"></div>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="box_main_3">
                            ...
                            <div class="image_2"><img src="{{ asset('template-user/images/img-4.png') }}"></div>
                        </div>
                    </div>
                    <div class="col-md-6">
    ...
    <div class="about_section layout_padding" id="about">
        <div class="container">
            ...
            <div class="about_main">
                <img src="{{ asset('template-user/images/img-5.png') }}" class="image_5">
            </div>
                        ...
                        <div class="client_main">
                            ...
                            <div class="client_section_2">
                                <div class="client_left">
                                    <div><img src="{{ asset('template-user/images/client-img.png') }}" class="client_img">
                                    </div>
                                </div>
                                <div class="client_right">
                                    <div class="quote_icon"><img src="{{ asset('template-user/images/quote-icon.png') }}">
                                    </div>
                ...
                <div class="row">
                    <div class="col-sm-4">
                        <div class="box_main_1">
                            <div class="zoomout frame"><img src="{{ asset('template-user/images/img-6.png') }}">
                            </div>
                    ...
                    <div class="col-sm-4">
                        <div class="box_main_1">
                            <div class="zoomout frame"><img src="{{ asset('template-user/images/img-7.png') }}">
                            </div>
                            <div class="padding_15">
                                <h2 class="speed_text">Speed cycle</h2>
                                <div class="post_text">Post by : Den <span style="float: right;">20-12-2019</span>
                    ...
                    <div class="col-sm-4">
                        <div class="box_main_1">
                            <div class="zoomout frame"><img src="{{ asset('template-user/images/img-8.png') }}">
                            </div>
                            <div class="padding_15">
